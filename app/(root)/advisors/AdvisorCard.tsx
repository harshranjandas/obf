...
export default function AdvisorCard({ advisor }: AdvisorCardProps) {
  const { name, role, imageUrl, linkedIn } = advisor;
  ...
  return (
    ...
    >
      ...
      <div className="relative flex-1 overflow-hidden">
        ...
        {/* Overlay area: default (white box) + hover (white text) */}
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-20 min-h-[35%] overflow-hidden">
          ...
          {/* Default: white panel with truncated role */}
          ...
          {/* Hover: white text over gradient, full role */}
