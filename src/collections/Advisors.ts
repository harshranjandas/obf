...
export const Advisors: CollectionConfig = {
  ...
  admin: {
    ...
    description: 'Advisors and their profiles for display on the site.',
  },
  access: {
    read: () => true,
  ...
  fields: [
    ...
    },
    {
      ...
      admin: {
        description: 'Active advisors are displayed on the site. Inactive advisors are hidden.',
      },
    },
    {
      name: 'displayOnHome',
      ...
      defaultValue: false,
      admin: {
        description: 'Display this advisor on the home page',
      },
    },
    {
      name: 'displayOrder',
      ...
      admin: {
        position: 'sidebar',
        description: 'Display order for advisors (lower numbers appear first). Leave empty to use default ordering.',
      },
    },
  ],
}
